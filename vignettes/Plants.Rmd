...
vignette: >
  %\VignetteIndexEntry{Detecting environmental outliers in environmental data for plants.}
...
modecom <- modelcomparison(refdata = plantcleaned, outliers = outliersdata, raster = worldclim,
                           lat = 'y', lon = 'x', models = c("GLM"), mode = 'abs',
                           thresholds = seq(0.2, 0.7, 0.1), full = FALSE)



modecom3 <- modelcomparison(refdata = p1cleaned, outliers = out1df, raster = worldclim,
                           lat = 'y', lon = 'x', models = c("GLM"), mode = 'abs',  
...
tp3 <- get_performance(modeloutput = modecom3)
