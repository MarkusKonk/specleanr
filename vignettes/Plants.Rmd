...
```{r extract performance}
#for one species
onespp <- get_performance(modelcomp  = onesppmodel)

#for multiple species
multspp <- get_performance(modelcomp = multsppmodel)
...
```{r visualisation2, fig.width = 9, fig.height= 4, fig.align='center'}
