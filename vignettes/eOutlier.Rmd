...
cleannames_df <- check_names(data = mergealldfs, colsp = 'species', pct = 70, 
...
multspecies_clean <- extract_clean_data(refdata = multipreclened, outliers = multioutliers, 
                                        loess =  TRUE)
...
labeldata <- classify_data(refdata = multipreclened, outliers = multioutliers)
head(labeldata)
